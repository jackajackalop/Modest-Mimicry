...
//http://hhoppe.com/hatching.pdf
	...
	// gamma
        ...
        "   vec2 model_coord = gl_FragCoord.xy*vec2(2.6,2.5)-vec2(0.9*width, 1.15*height); \n"
    ...
    glUniform1i(glGetUniformLocation(program, "hatch0_tex"), 1);
    glUniform1i(glGetUniformLocation(program, "hatch1_tex"), 2);
    glUniform1i(glGetUniformLocation(program, "hatch2_tex"), 3);
    glUniform1i(glGetUniformLocation(program, "hatch3_tex"), 4);
    glUniform1i(glGetUniformLocation(program, "hatch4_tex"), 5);
...
Load< MainProgram > main_program(LoadTagInit, [](){
